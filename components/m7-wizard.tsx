  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 p-4 sm:p-6 lg:p-8">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg sm:text-xl font-bold text-foreground">Pilotes (Cabezales)</h1>
          </div>
          <p className="mt-1 text-xs sm:text-sm text-muted-foreground">Perfil estratigrafico, capacidad, cabezal Jimenez Montoya</p>
        </div>
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {step < STEPS.length - 1 ? (
          <Button size="sm" onClick={handleNext} className="gap-1.5 sm:gap-2">{step === 2 && !results ? <><Calculator className="h-4 w-4" /> Calcular</> : <><span className="hidden xs:inline">Siguiente</span> <ArrowRight className="h-4 w-4" /></>}</Button>
